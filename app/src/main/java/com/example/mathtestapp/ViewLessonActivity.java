...
public class ViewLessonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedLesson = getIntent().getStringExtra("SelectedLesson");
        ...
        adapter = new FragmentAdapter(fm,getLifecycle(),selectedLesson);
        pager2.setAdapter(adapter);

        tabLayout.addTab(tabLayout.newTab().setText("Правило"));
